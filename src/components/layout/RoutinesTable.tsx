...
/**
 * RoutinesTable component - Displays routine data in a table format
 * Includes internal badge utilities and date formatting
 * Optimized with memoized utility functions for better performance
 */
export function RoutinesTable({
  routines,
  onRoutineClick,
}: RoutinesTableProps) {
  // Memoized badge utility functions for better performance
